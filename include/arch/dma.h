...
#define DMAC_CFG_TYPE_SRAM (0)
	...
	defined(CONFIG_ARCH_SUN20IW5P1) || \
...
#define DMAC_CFG_SRC_TYPE_NAND (5)
#elif defined(CONFIG_ARCH_SUN50IW11) || defined(CONFIG_ARCH_SUN55IW3) || defined(CONFIG_ARCH_SUN55IW5)
#define DMAC_CFG_TYPE_SPI0 (22)
