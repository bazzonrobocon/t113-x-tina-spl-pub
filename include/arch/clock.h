...
#include <arch/sun20iw5p1/clock_sun20iw5_aon.h>
#include <arch/sun20iw5p1/clock_sun20iw5_app.h>
...
#include <arch/sun55iw5p1/clock_sun55iw5.h>
#elif defined(CONFIG_ARCH_SUN55IW6)
#include <arch/sun55iw6p1/clock_sun55iw6.h>
#else
#error "Unsupported plat"
#endif

#if defined(CONFIG_ARCH_SUN55IW3) || defined(CONFIG_ARCH_SUN55IW5) ||          \
	defined(CONFIG_ARCH_SUN55IW6) || defined(CONFIG_ARCH_SUN60IW1) ||      \
	defined(CONFIG_ARCH_SUN60IW2)
